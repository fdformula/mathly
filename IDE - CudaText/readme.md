## [CudaText](https://cudatext.github.io/) is a very good "IDE" for MathLua
...
```
  ...
  F2               to start MathLua in the folder of the current file
  ...
  Ctrl-Space       to trigger auto (Lua and MathLua) lexical completion
  Ctrl-Alt-Space   to trigger auto (Lua and MathLua) lexical completion wiht more items
...
&rArr; MacOS users? Download the file, [cudatext-for-mathlua-macosx.tar.gz](https://github.com/fdformula/mathly/blob/main/IDE%20-%20CudaText/cudatext-for-mathlua-macos.tar.gz). Expand the downloaded file
and refer to the included file, `note.txt`, for other steps.

`Note`: [Lite XL](https://github.com/fdformula/mathly/tree/main/IDE%20-%20Lite%20XL) is another very good "IDE" for MathLua.
