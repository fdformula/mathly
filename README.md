...
Mathly (aka Lua + Mathly) for [Lua](https://www.lua.org) is a Lua module that turns Lua into a tiny, portable, free but powerful MATLAB and more. It provides a group of commonly
